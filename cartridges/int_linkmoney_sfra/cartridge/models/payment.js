...
function getSelectedPaymentInstruments(selectedPaymentInstruments) {
  return collections.map(selectedPaymentInstruments, function (paymentInstrument) {
    ...
    } else if (paymentInstrument.paymentMethod === constants.LINK_PAYMENT_METHOD_ID) {
      results.linkedBankName = paymentInstrument.custom.linkedBankName;
      results.linkedBankLastNumbers = paymentInstrument.custom.linkedBankLastNumbers;
      results.linkedBankIcon = paymentInstrument.custom.linkedBankIcon;
    }
    return results;
  });
}
